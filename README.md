...
curl -L https://github.com/sbacaro/Hydra-Soundcard/releases/download/v1.0.4/Hydra-1.0.4.pkg -o Hydra.pkg
open Hydra.pkg
```

### Manual Installation
Download the [ZIP archive](https://github.com/sbacaro/Hydra-Soundcard/releases/download/v1.0.4/Hydra-1.0.4.zip) and run:

```bash
unzip Hydra-1.0.4.zip
cd Hydra-1.0.4
...
**Latest Release:** [Hydra 1.0.4](https://github.com/sbacaro/Hydra-Soundcard/releases/tag/v1.0.4) · Released June 26, 2026